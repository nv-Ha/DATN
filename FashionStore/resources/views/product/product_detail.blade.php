...
<div class="container box pad">
		...
		<div class="col-xs-12">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<br><label for="" style="margin-top: 10px;">Giá bán</label>
						...
						<input type="hidden" id="getProductsIdStr" class="input-text form-control" value="{{$products_id_str}}" />
										...
										<tr>
											<td class="col-sm-1" style="text-align : center;">
												<label class="check-sty">
													<input data-id="{{$value->id}}" type="checkbox" @if(isset($variants[$value->id])) {{'checked'}} @endif>
	...
	<script type="text/javascript">
		...
		var productsIdStr = $('#getProductsIdStr').val();
		var prod_id_arr = productsIdStr?.split(',').filter(o => o);
		console.log("prod_id_arr = ", prod_id_arr)
		var variant_product_ids = prod_id_arr;
